...
public final class SDL_ButtonMask implements JnaEnum {
    ...
    public static final int SDL_BUTTON_LMASK = SDL_BUTTON(SDL_Button.SDL_BUTTON_LEFT);
    public static final int SDL_BUTTON_MMASK = SDL_BUTTON(SDL_Button.SDL_BUTTON_MIDDLE);
    public static final int SDL_BUTTON_RMASK = SDL_BUTTON(SDL_Button.SDL_BUTTON_RIGHT);
    public static final int SDL_BUTTON_X1MASK = SDL_BUTTON(SDL_Button.SDL_BUTTON_X1);
    public static final int SDL_BUTTON_X2MASK = SDL_BUTTON(SDL_Button.SDL_BUTTON_X2);
