...
import static com.github.carlwilk32.sdl.core.api.log.SDL_LogPriority.SDL_LOG_PRIORITY_CRITICAL;
import static com.github.carlwilk32.sdl.core.api.log.SDL_LogPriority.SDL_LOG_PRIORITY_DEBUG;
import static com.github.carlwilk32.sdl.core.api.log.SDL_LogPriority.SDL_LOG_PRIORITY_ERROR;
...
import static com.github.carlwilk32.sdl.core.api.log.SDL_LogPriority.SDL_LOG_PRIORITY_WARN;
...
public final class SdlLog {
    ...
    public static void SDL_Log(
            String fmt,
            Object... args) {
        if (fmt.length() > SdlLogConst.SDL_MAX_LOG_MESSAGE) {
            throw new IllegalArgumentException("Log message is too long (" + fmt.length() + " characters), maximum is " + SdlLogConst.SDL_MAX_LOG_MESSAGE);
        }
