...
import com.github.carlwilk32.sdl.core.api.rect.SDL_FPoint;
import com.github.carlwilk32.sdl.core.api.rect.SDL_FRect;
import com.github.carlwilk32.sdl.core.api.rect.SDL_Point;
import com.github.carlwilk32.sdl.core.api.rect.SDL_Rect;
import com.github.carlwilk32.sdl.core.api.surface.SDL_Surface;
import com.github.carlwilk32.sdl.core.api.video.SDL_GLContext;
import com.github.carlwilk32.sdl.core.api.video.SDL_Window;
import com.github.carlwilk32.sdl.core.api.video.SDL_WindowFlags;
import com.github.carlwilk32.sdl.core.api.video.SdlVideo;
import com.github.carlwilk32.sdl.core.jna.ContiguousArrayList;
import com.github.carlwilk32.sdl.core.jna.JnaUtils;
import com.github.carlwilk32.sdl.core.jna.SdlNativeLibraryLoader;
import com.github.carlwilk32.sdl.core.api.pixels.SDL_PixelFormatEnum;
...
import static com.github.carlwilk32.sdl.core.api.error.SdlError.SDL_SetError;
...
public final class SdlRender {
    ...
    public static int SDL_RenderDrawPoints(
        ...
        if (intXandY.length % 2 != 0) {
            SdlError.SDL_SetError("Invalid length of the int[] array. It must consist of pairs of `int x` and `int y`.");
            return -1;
        }
     ...
     * SDL_GetError() for more information.
     * @see SdlVideo#SDL_GL_MakeCurrent(SDL_Window, SDL_GLContext)
