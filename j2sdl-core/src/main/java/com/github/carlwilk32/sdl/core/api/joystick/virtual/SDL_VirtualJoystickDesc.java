package com.github.carlwilk32.sdl.core.api.joystick.virtual;

import com.github.carlwilk32.sdl.core.api.gamecontroller.SDL_GameControllerAxis;
 ...
 *
 * @see SdlJoystick#SDL_JoystickAttachVirtualEx(SDL_VirtualJoystickDesc)
 */
...
public final class SDL_VirtualJoystickDesc extends Structure {
    ...
    @MagicConstant(intValues = SdlJoystickConst.SDL_VIRTUAL_JOYSTICK_DESC_VERSION)
