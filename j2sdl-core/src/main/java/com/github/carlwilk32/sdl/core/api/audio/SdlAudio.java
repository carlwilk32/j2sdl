...
public final class SdlAudio {
    ...
    public static SDL_AudioSpec SDL_LoadWAV(
            ...
            PointerByReference audioBuf,
            IntByReference audioLen) {
        return SDL_LoadWAV_RW(SdlRWops.SDL_RWFromFile(file, "rb"), 1, spec, audioBuf, audioLen);
    }
