...
import com.github.carlwilk32.sdl.core.api.gamecontroller.SdlGamecontroller;
 ...
 * with the {@link SdlSubSystemConst#SDL_INIT_JOYSTICK SDL_INIT_JOYSTICK} flag.  This causes SDL to scan the system
...
public final class SdlJoystick {
     ...
     * @see SdlGamecontroller#SDL_GameControllerEventState(int)
     * @since This function is available since SDL 2.0.0.
     */
