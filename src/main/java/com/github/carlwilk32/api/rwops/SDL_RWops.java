...
public final class SDL_RWops extends Structure {
    ...
    public void read() {
        readField("type");
        switch (type) {
            case SDL_RWopsType.SDL_RWOPS_WINFILE:
                hidden.setType(SDL_RWopsWindowsIO.class);
                break;
            case SDL_RWopsType.SDL_RWOPS_STDFILE:
                hidden.setType(SDL_RWopsStdIO.class);
                break;
            case SDL_RWopsType.SDL_RWOPS_JNIFILE:
                hidden.setType(SDL_RWopsAndroidIO.class);
                break;
            case SDL_RWopsType.SDL_RWOPS_MEMORY:
            case SDL_RWopsType.SDL_RWOPS_MEMORY_RO:
                hidden.setType(SDL_RWopsMemoryIO.class);
                break;
            case SDL_RWopsType.SDL_RWOPS_UNKNOWN:
            default:
