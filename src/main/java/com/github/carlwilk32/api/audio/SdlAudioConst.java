...
import com.github.carlwilk32.api.endian.SdlEndianConst;
...
public final class SdlAudioConst {
    ...
    static {
        if (SdlEndianConst.SDL_BYTEORDER == SdlEndianConst.SDL_LIL_ENDIAN) {
            AUDIO_U16SYS = AUDIO_U16LSB;
            AUDIO_S16SYS = AUDIO_S16LSB;
            AUDIO_S32SYS = AUDIO_S32LSB;
            AUDIO_F32SYS = AUDIO_F32LSB;
        } else if (SdlEndianConst.SDL_BYTEORDER == SdlEndianConst.SDL_BIG_ENDIAN) {
