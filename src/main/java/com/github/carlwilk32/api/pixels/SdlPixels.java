...
import com.github.carlwilk32.api.surface.SdlSurface;
...
public final class SdlPixels {
     ...
     * @see #SDL_AllocPalette(int)
     * @see SdlSurface#SDL_CreateRGBSurface(int, int, int, int, int, int, int, int)
     * @since This function is available since SDL 2.0.0.
     */
     ...
     * @see SdlVideo#SDL_SetWindowGammaRamp(SDL_Window, short[], short[], short[]) SDL_SetWindowGammaRamp(SDL_Window, short[], short[], short[])
     * @since This function is available since SDL 2.0.0.
     */
